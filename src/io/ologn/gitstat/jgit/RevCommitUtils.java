...
public class RevCommitUtils {
	 ...
	 * @param git
	 * @return a list (Iterable) of RevCommit objects
	 * @throws NoHeadException
	 * @throws GitAPIException
	 * @throws IOException
	 */
	public static Iterable<RevCommit> getAllCommits(Git git)
			throws NoHeadException, GitAPIException, IOException {
		return git.log().all().call();
	}
	
	/**
	 * Get a list (Iterable) of RevCommit objects that contains certain paths
	 * @param git
	 * @param paths
	 * @return a list (Iterable) of RevCommit objects
	 * @throws NoHeadException
	 * @throws GitAPIException
	 */
	public static Iterable<RevCommit> getCommitsWithPath(Git git,
